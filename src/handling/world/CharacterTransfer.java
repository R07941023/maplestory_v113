...
public class CharacterTransfer implements Externalizable {
    ...
    public boolean check_msg_BuyMerChant, check_msg_Chat, check_msg_MobVac, Vip_Medal, DebugMessage, canTalk, smega, showLogin, showRegister, attackdebug, hasVac, GachaponMega;
    ...
    public CharacterTransfer(final MapleCharacter chr) {
        ...
        this.hasVac = chr.getHasVac();     
        this.GachaponMega = chr.getGachaponmega();        
    ...
    public void readExternal(final ObjectInput in) throws IOException, ClassNotFoundException {
        ...
        this.hasVac = in.readBoolean();   
        this.GachaponMega = in.readBoolean();        
    ...
    public void writeExternal(final ObjectOutput out) throws IOException {
        ...
        out.writeBoolean(this.hasVac);     
        out.writeBoolean(this.GachaponMega);        
