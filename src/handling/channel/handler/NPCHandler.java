                ...
                if (chr.getMeso() < 100 || chr.getMapId() == 910000000 && chr.getMeso() < 500) {
                    ...
                    if (item.getItemId() == itemId && (item.getQuantity() >= quantity || GameConstants.isThrowingStar(itemId) || GameConstants.isBullet(itemId))) {
                        ...
                        storage.sendStored(c, GameConstants.getInventoryType(itemId));
                            ...
                            World.Broadcast.broadcastGMMessage(MaplePacketCreator.getItemNotice("[GM密語] " + " 帳號: " + c.getAccountName() + " 玩家: " + c.getPlayer().getName() + " 使用了倉庫操作存入物品:" + item.getItemId() + " 數量：" + item.getQuantity()));                        
            ...
            case 7: {
                ...
                if ((meso > 0 && storageMesos >= meso) || (meso < 0 && playerMesos >= -meso)) {
                    ...
                    storage.saveToDB();
                        ...
                        World.Broadcast.broadcastGMMessage(MaplePacketCreator.getItemNotice("[GM密語] " + " 帳號: " + c.getAccountName() + " 玩家: " + c.getPlayer().getName() + " 使用了倉庫操作金幣數量:" + meso));

                        if (meso >= 500000000 || meso <= -500000000) {
                            ...
                            World.Broadcast.broadcastGMMessage(MaplePacketCreator.getItemNotice("[GM密語] " + " 帳號: " + c.getAccountName() + " 玩家: " + c.getPlayer().getName() + " 使用了倉庫大額金幣操作數量:" + meso));
                        }
