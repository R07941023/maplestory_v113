...
//        closeAllMerchant();
    ...
    public void broadcastSmega(byte[] message) {
     ...
     public void broadcastGachaponmega(byte[] message) {
        broadcastGachaponmegaPacket(message);
    }
    
    public final void broadcastGachaponmegaPacket(final byte[] data) {
        getPlayerStorage().broadcastGachaponmegaPacket(data);
    }
