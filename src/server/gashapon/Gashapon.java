...
//                System.out.println(chance+" "+getId()+" "+itemid);
        ...
        FileoutputUtil.logToFile("logs/GM_LOG/GM新增轉蛋物機率.txt", "\r\n" + FileoutputUtil.NowTime() + "GM: " + chr.getName() + "  新增轉蛋物品:" + MapleItemInformationProvider.getInstance().getName(itemid) + " 機率設定為" + chance + " 是否上綠廣:" + (msg ? "是" : "否"));
