...
//        }
    ...
    public void addCashShopItem(int sn, String note) {
        if (CashItemFactory.getInstance().getModItem(sn) == null) {
            CashItem ci = CashItemFactory.getInstance().getSimpleItem(sn);
            CashModItem cModItem = new CashModItem(ci.getSN(), note, ci.getId(), ci.getCount(), ci.getPrice(), ci.getPeriod(), ci.getGender(), ci.getFlage(), ci.isOnSale());
    ...
    public void updateCashShopItem(Object[] values) {
        if (values != null && values.length > 8) {
            if (values[0] instanceof Integer) {
                CashModItem cModItem = CashItemFactory.getInstance().getModItem((int) values[0]);
                if (cModItem != null) {
                    cModItem.setSN((int) values[0]);
                    cModItem.setNote((String) values[1]);
                    cModItem.setId((int) values[2]);
                    ...
                    cModItem.setFlage((int) values[8]);
    ...
    private void initComponents() {
        ...
        jPanel15Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel15Layout.createSequentialGroup()
                ...
                .addGroup(jPanel15Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addComponent(jButton42, javax.swing.GroupLayout.PREFERRED_SIZE, 117, Short.MAX_VALUE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                    ...
                    .addGroup(jPanel8Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel8Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel8Layout.createSequentialGroup()
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addGroup(jPanel8Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addComponent(jScrollPanel11, javax.swing.GroupLayout.DEFAULT_SIZE, 668, Short.MAX_VALUE)
                                    .addGroup(jPanel8Layout.createSequentialGroup()
        ...
        jPanel8Layout.setVerticalGroup(
            ...
            .addGroup(jPanel8Layout.createSequentialGroup()
                ...
                .addGroup(jPanel8Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(jScrollPanel11, javax.swing.GroupLayout.DEFAULT_SIZE, 438, Short.MAX_VALUE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(jPanel8Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jButton48)
                    .addComponent(jButton49)
        ...
        jPanel6Layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel6Layout.createSequentialGroup()
                .addComponent(jLabel28, javax.swing.GroupLayout.DEFAULT_SIZE, 895, Short.MAX_VALUE)
                .addContainerGap())
        );
        jPanel6Layout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel6Layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(jLabel28, javax.swing.GroupLayout.DEFAULT_SIZE, 494, Short.MAX_VALUE)
                .addContainerGap())
        );
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(jLabel45, javax.swing.GroupLayout.DEFAULT_SIZE, 900, Short.MAX_VALUE))
